package com.minglang.suiuu.view.progressbar;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.text_color1);
        mColors[1] = context.getResources().getColor(R.color.remindColor);
        mColors[2] = context.getResources().getColor(R.color.comment_title_color);
        mColors[3] = context.getResources().getColor(R.color.text_select_true);
