...
public class WebSocketClient {
    ...
    private HyperionParser mParser;
    ...
    public WebSocketClient(URI uri, Listener listener, List<BasicNameValuePair> extraHeaders) {
        ...
        mConnected = false;
        mParser = new HyperionParser(this);
        ...
        mThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    HyperionParser.HappyDataInputStream stream = new HyperionParser.HappyDataInputStream(mSocket.getInputStream());
    ...
    private String readLine(HyperionParser.HappyDataInputStream reader) throws IOException {
